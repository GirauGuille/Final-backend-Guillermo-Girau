...
import { ADMIN_EMAIL, GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GITHUB_CLIENT_ID, GITHUB_CLIENT_SECRET } from '../config/config.js';
...
passport.use(
  ...
  new GithubStrategy(
    ...
    async (accessToken, refreshToken, profile, done) => {
      ...
      } catch (e) {console.error(e);done(null, false);
      }
    }
  )
);
